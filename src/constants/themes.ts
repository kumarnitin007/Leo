...
export const themes: Theme[] = [
  ...
  },
  {
    ...
    name: 'Corporate Navy',
    emoji: '💼',
    description: 'Professional navy blue for business environments',
    colors: {
      primary: '#1e3a8a',
      secondary: '#1e40af',
      accent: '#3b82f6',
  ...
  },
  {
    ...
    emoji: '🏢',
    description: 'Sophisticated slate gray for executive presence',
    colors: {
      primary: '#334155',
      secondary: '#475569',
      accent: '#64748b',
  ...
  },
  {
    ...
    emoji: '📊',
    description: 'Modern charcoal with subtle warmth for professionals',
    colors: {
      primary: '#374151',
      secondary: '#4b5563',
      accent: '#6b7280',
  ...
  },
  {
    ...
    name: 'Warm Paper',
    emoji: '📜',
    description: 'Crisp paper aesthetic — clean, warm, and editorial',
    colors: {
      primary: '#1a1a1a',
      secondary: '#3a3a3a',
      accent: '#e8c547',
  ...
  {
    id: 'banker-burgundy',
    name: 'Banker Burgundy',
    emoji: '🏦',
    description: 'Classic burgundy for traditional business settings',
    colors: {
      primary: '#7c2d12',
      secondary: '#991b1b',
      accent: '#b91c1c',
